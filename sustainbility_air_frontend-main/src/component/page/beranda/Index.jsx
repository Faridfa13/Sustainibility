...
export default function PowerDataChart() {
  ...
  useEffect(() => {
    const fetchBarData = async () => {
      try {
        ...
        if (!Array.isArray(data) || data.length === 0) {
          alert("Data tidak ditemukan untuk Bar Chart.");
          return;
        }
        ...
        alert("Gagal memuat data untuk Bar Chart.");
      }
    };
    ...
    const fetchSensorData = async () => {
      try {
        ...
        if (!Array.isArray(data) || data.length === 0) {
          alert("Data tidak ditemukan untuk Tabel.");
          return;
        }
        ...
        alert("Gagal memuat data untuk tabel.");
      }
    };
  ...
  if (!barChartData || !lineChartData || sensorData.length === 0) return <div>Loading...</div>;
